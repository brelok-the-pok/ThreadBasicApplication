...
//int threadCount = 8;
//
//double oneThreadResaults = 0;
//double multiThreadResaults = 0;
//
//int maxCount = 800000;
//int* array1 = new int[maxCount];
//int* array2 = new int[maxCount];
...
//for (int i = 0; i < testCount; i++)
//{
//    oneThreadResaults += OneThreadTest(array1, maxCount);
//}
//end = omp_get_wtime();
//
//cout << "Секунд ушло на тестирование одногопоточной функции: " << end - start << endl;
//cout << "Секунд ушло на работу однопоточного алгоритма: \n" << oneThreadResaults / testCount << endl;
//
//start = omp_get_wtime();
//for (int i = 0; i < testCount; i++)
//{
//    multiThreadResaults += MultiThreadTest(array2, maxCount, threadCount);
//}
//end = omp_get_wtime();
//
//cout << "Секунд ушло на тестирование многопоточной функции: " << end - start << endl;
//cout << "Секунд ушло на работу многопоточного алгоритма: " << multiThreadResaults / testCount << endl;
//
//CompareArays(array1, array2, maxCount);
//
//delete[] array1;
